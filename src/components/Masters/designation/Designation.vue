            ...
            <v-dialog v-model="dialog" persistent max-width="500px">
              <template v-slot:activator="{ on }">
                <v-card-title>
                  ...
                  <v-text-field
                    v-model="search"
                    placeholder="Search Designation Wise"
                    append-icon="search"
                    label="Search"
                    single-line
                    hide-details
                  ...
                  <v-form ref="form">
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" md="6">
                          <v-text-field
                            v-model="editedItem.designation_short_name"
                            label="Disignation Short Name "
                          ></v-text-field>
                        </v-col>
                      </v-row>
                      <v-row>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "Designation Short Name",
        align: "left",
        sortable: false,
        value: "designation_short_name",
        width: 100
      },
      {
        text: "Status",
