            ...
            <v-card-text>
              <v-form ref="form">
                <v-container>
                  ...
                  <!-- </v-col> -->
                  <!-- <v-col cols="12" md="12"> -->
                  <v-textarea v-model="editedItem.remarks1" rows="2" label="Remarks " outlined></v-textarea>
                  <v-btn class="ma-2" outlined color="indigo" rounded>Reject</v-btn>

                  <v-btn class="ma-2" outlined color="error" rounded>Approve</v-btn>
